...
# Add apps
su -c "wget -O /home/$USER/gradio-apps.conf https://raw.githubusercontent.com/carlgira/oci-gradio-app-manager/main/gradio-apps.conf" $USER
...
su -c "mapfile -t < /home/$USER/gradio-apps.conf; source /home/$USER/add-gradio-app.sh \"\${MAPFILE[@]}\"" $USER
